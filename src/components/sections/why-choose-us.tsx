    ...
    <section id="why-us" className="py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6 max-w-7xl">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight bg-gradient-to-br from-[#3B6AF5] to-[#2F5FE3] bg-clip-text text-transparent">Why Choose ITLC India?</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature) => (
             ...
             <CardHeader className="items-center">
               <div className="p-5 bg-[#E9EEFF] text-primary rounded-[16px] mb-4 inline-block">
                 <feature.icon className="w-8 h-8" />
               </div>
               <CardTitle className="text-lg font-semibold tracking-tight bg-gradient-to-br from-[#3B6AF5] to-[#2F5FE3] bg-clip-text text-transparent">{feature.title}</CardTitle>
             </CardHeader>
             <CardContent>
