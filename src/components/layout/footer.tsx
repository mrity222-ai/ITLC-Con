      ...
      <div className="container mx-auto max-w-7xl px-4 md:px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-2xl font-bold font-headline text-foreground mb-2 leading-tight">
              Design & Construction
            </h3>
          ...
          {/* Column 2: Services */}
          <div>
            <h4 className="font-semibold font-headline text-lg mb-4 text-foreground">Services</h4>
          ...
          <div>
            <h4 className="font-semibold font-headline text-lg mb-4 text-foreground">Quick Links</h4>
            <ul className="space-y-3">
              {quickLinks.map(link => (
                <li key={link.name}>
          ...
          <div>
            <h4 className="font-semibold font-headline text-lg mb-4 text-foreground">Contact Us</h4>
